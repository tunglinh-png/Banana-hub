--[[
    BANANA HUB PREMIUM - BLOX FRUIT
    Chống Ban + Chống Kick + Đầy đủ tính năng
]]

-- ================= CHỐNG BAN =================
local function ChongBan()
    -- Chống ban qua metamethod
    local KiemTraCu = hookmetamethod(game, "__namecall", function(tu, ...)
        local PhuongThuc = getnamecallmethod()
        local args = {...}
        
        -- Chặn các lệnh ban
        if PhuongThuc == "Ban" or PhuongThuc == "Kick" or PhuongThuc == "FireServer" then
            if tu.Name:lower():find("ban") or tu.Name:lower():find("kick") then
                return nil
            end
        end
    ...
    -- Chống ban qua RemoteEvent
    for _, SuKien in pairs(game.Players.LocalPlayer:GetChildren()) do
        if SuKien:IsA("RemoteEvent") then
            if SuKien.Name:lower():find("ban") or SuKien.Name:lower():find("kick") then
                SuKien:Destroy()
            end
        end
    end
    
    -- Chống ban qua Script
    for _, Script in pairs(workspace:GetDescendants()) do
        if Script:IsA("Script") or Script:IsA("LocalScript") then
            if Script.Name:lower():find("ban") or Script.Name:lower():find("kick") or Script.Name:lower():find("anticheat") then
                Script:Destroy()
            end
        end
    end
...
local function ChongKick()
    -- Chống kick cơ bản
    local KichCu = game.Players.LocalPlayer.Kick
    game.Players.LocalPlayer.Kick = function(...) return nil end
    
    -- Chống kick qua namecall
    local KiemTraCu = hookmetamethod(game, "__namecall", function(tu, ...)
        local PhuongThuc = getnamecallmethod()
        if PhuongThuc == "Kick" then
            return nil
        end
        return KiemTraCu(tu, ...)
    end)
    
    -- Chống kick qua index
    local IndexCu = hookmetamethod(game, "__index", function(tu, khoa)
        if khoa == "Kick" and tu == game.Players.LocalPlayer then
            return function() return nil end
        end
        return IndexCu(tu, khoa)
    end)
end
    ...
    spawn(function()
        while ChayUngDung do
            ...
            if NguoiChoi.Character then
                ...
                if Goc then
                    local ViTriCu = Goc.Position
                    Goc.CFrame = Goc.CFrame * CFrame.new(1, 0, 0)
                    wait(0.1)
                    Goc.CFrame = CFrame.new(ViTriCu)
                end
            end
        end
    end)
...
NutMo.Name = "NutMo"
NutMo.Size = UDim2.new(0, 65, 0, 65)
NutMo.Position = UDim2.new(0, 10, 0.5, -32)
NutMo.BackgroundColor3 = Color3.fromRGB(255, 180, 0)
...
local VienNutMo = Instance.new("UIStroke")
VienNutMo.Thickness = 3
VienNutMo.Color = Color3.fromRGB(255, 220, 100)
VienNutMo.Parent = NutMo

local KhungChinh = Instance.new("Frame")
KhungChinh.Name = "KhungChinh"
KhungChinh.Size = UDim2.new(0, 500, 0, 620)
KhungChinh.Position = UDim2.new(0.5, -250, 0.5, -310)
KhungChinh.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
KhungChinh.BorderSizePixel = 0
KhungChinh.Visible = false
KhungChinh.Parent = ManHinh

local GocKhung = Instance.new("UICorner")
GocKhung.CornerRadius = UDim.new(0, 20)
GocKhung.Parent = KhungChinh

local VienKhung = Instance.new("UIStroke")
VienKhung.Thickness = 3
VienKhung.Color = Color3.fromRGB(255, 180, 0)
VienKhung.Parent = KhungChinh

local ThanhTieuDe = Instance.new("Frame")
ThanhTieuDe.Size = UDim2.new(1, 0, 0, 60)
ThanhTieuDe.BackgroundColor3 = Color3.fromRGB(255, 180, 0)
ThanhTieuDe.BorderSizePixel = 0
ThanhTieuDe.Parent = KhungChinh

local GocTieuDe = Instance.new("UICorner")
GocTieuDe.CornerRadius = UDim.new(0, 20)
GocTieuDe.Parent = ThanhTieuDe

local Logo = Instance.new("TextLabel")
Logo.Size = UDim2.new(0, 55, 0, 55)
Logo.Position = UDim2.new(0, 8, 0, 2)
Logo.BackgroundTransparency = 1
Logo.Text = "🍌"
Logo.TextSize = 35
Logo.Parent = ThanhTieuDe

local TieuDe = Instance.new("TextLabel")
TieuDe.Size = UDim2.new(1, -180, 0, 35)
TieuDe.Position = UDim2.new(0, 65, 0, 2)
...
PhuDe.Size = UDim2.new(1, -180, 0, 20)
PhuDe.Position = UDim2.new(0, 65, 0, 35)
PhuDe.BackgroundTransparency = 1
PhuDe.Text = "⭐ PREMIUM EDITION ⭐"
PhuDe.TextColor3 = Color3.fromRGB(255, 255, 200)
PhuDe.TextSize = 11
PhuDe.Font = Enum.Font.SourceSansBold
...
NutX.Position = UDim2.new(1, -100, 0, 7)
...
NutRutGon.Position = UDim2.new(1, -50, 0, 7)
NutRutGon.BackgroundColor3 = Color3.fromRGB(255, 120, 0)
NutRutGon.BorderSizePixel = 0
NutRutGon.Text = "—"
NutRutGon.TextColor3 = Color3.fromRGB(255, 255, 255)
NutRutGon.TextSize = 22
...
NutRutGon.MouseButton1Click:Connect(function()
    ...
    if MenuRutGon then
        KhungChinh.Size = UDim2.new(0, 500, 0, 60)
        KhungChinh.Position = UDim2.new(0.5, -250, 0, 5)
        NutRutGon.Text = "+"
    else
        KhungChinh.Size = UDim2.new(0, 500, 0, 620)
        KhungChinh.Position = UDim2.new(0.5, -250, 0.5, -310)
...
NutMo.MouseButton1Click:Connect(function()
    ...
    if MenuMo then
        KhungChinh.Scale = UDim2.new(0, 0, 0, 0)
        DichVuBo:Create(KhungChinh, TweenInfo.new(0.35, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
...
KhungNoiDung.Size = UDim2.new(1, 0, 1, -65)
KhungNoiDung.Position = UDim2.new(0, 0, 0, 65)
KhungNoiDung.BackgroundTransparency = 1
KhungNoiDung.CanvasSize = UDim2.new(0, 0, 35, 0)
KhungNoiDung.ScrollBarThickness = 5
KhungNoiDung.ScrollBarImageColor3 = Color3.fromRGB(255, 180, 0)
...
local function TaoPhan(Ten, BieuTuongPhan)
    ...
    KhungPhan.Size = UDim2.new(1, -20, 0, 40)
...
local function TaoNut(Ten, BieuTuongNut, Callback)
    ...
    GocNut.CornerRadius = UDim.new(0, 8)
    GocNut.Parent = Nut
    
    Nut.MouseEnter:Connect(function()
        DichVuBo:Create(Nut, TweenInfo.new(0.2), {
            BackgroundColor3 = Color3.fromRGB(80, 60, 0)
        }):Play()
    end)
...
local function TaoToggle(Ten, MacDinh, Callback)
    local Khung = Instance.new("Frame")
    Khung.Size = UDim2.new(1, -20, 0, 42)
    ...
    local GocKhung = Instance.new("UICorner")
    GocKhung.CornerRadius = UDim.new(0, 8)
    ...
    local Nut = Instance.new("TextButton")
    Nut.Size = UDim2.new(0.3, -10, 0, 32)
    Nut.Position = UDim2.new(0.7, 5, 0, 5)
    Nut.BackgroundColor3 = MacDinh and Color3.fromRGB(255, 180, 0) or Color3.fromRGB(60, 60, 60)
    Nut.BorderSizePixel = 0
    ...
    local GocNut = Instance.new("UICorner")
    GocNut.CornerRadius = UDim.new(0, 5)
    GocNut.Parent = Nut
    ...
    Nut.MouseButton1Click:Connect(function()
        ...
        DichVuBo:Create(Nut, TweenInfo.new(0.2), {
            BackgroundColor3 = TrangThai and Color3.fromRGB(255, 180, 0) or Color3.fromRGB(60, 60, 60)
        }):Play()
...
local function TaoDropdown(Ten, DanhSach, MacDinh, Callback)
    ...
    KhungDropdown.Position = UDim2.new(0, 10, 0, YViTri + 47)
...
KhungChinh.Scale = UDim2.new(0, 0, 0, 0)
DichVuBo:Create(KhungChinh, TweenInfo.new(0.5, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
    Scale = UDim2.new(1, 0, 1, 0)
}):Play()
MenuMo = true