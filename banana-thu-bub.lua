...
getgenv().LPH_ATTRIBUTES = LPH_ATTRIBUTES
getgenv().VM = VM
getgenv().NONE = NONE
...
function SpecialHop(C)
	if getgenv().Key and #getgenv().Key == nil then
		return
	end
...
spawn(function()
	pcall(function()
		...
		T(
			string.format(
				' repeat wait() until game:IsLoaded()\10 getgenv().Key = " public" getgenv().__BANANA_SCRIPT_ROUTE = "bf_main"\10 return loadstring(game:HttpGet("https://banana-hub.xyz/loader/banana.lua"))()\10 ',
				getgenv().Key = "public"
			)
		)
	end)
